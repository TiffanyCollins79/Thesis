...
\begin{equation}
	\begin{aligned}
		n\qty(\gamma,t,x,y,z)&=\iiint_{x,y,z=-\infty}^{\infty} n_\text{green}\qty(\boldsymbol{r}-\boldsymbol{s_r})R_\text{source}\qty(\boldsymbol{s_r})\dd{\boldsymbol{s_r}} \text{ ,} 
...
\begin{equation}
    \begin{aligned}
    \qty(\pdv{n}{t})_\text{adv}&=-\boldsymbol{v}_A\nabla n\text{ .} 
